  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-hairline bg-transparent text-foreground hover:bg-secondary hover:border-muted-foreground rounded-sm",
        ...
        hero: "bg-foreground text-background font-medium rounded-none hover:bg-foreground/90 hover:scale-[1.02]",
        heroOutline: "border border-foreground/40 bg-transparent text-foreground font-light rounded-none hover:bg-foreground/10 hover:border-foreground",
        gold: "bg-gold text-background font-medium rounded-sm hover:bg-gold-muted",
      },
      size: {
